...
# ─────────────────────────────────────────────────────────────────────────────
# ─────────────────────────────────────────────────────────────────────────────
# PREDEFINED ROLES — from Roles_Users_Access_Resource.xlsx
# Numeric IDs resolved via pattern dump. 33 roles, all accurate.
# ─────────────────────────────────────────────────────────────────────────────
PREDEFINED_ROLES: dict[str, list[str]] = {
    ...
    "ALL_FACILITY": [
        ...
        "UNVERIFIED_ORDERS",
        "VERIFY_PENDING_ORDERS",
        "WIDGET_MULTI_FACILITY_PENDING_ORDERS",
        "WIDGET_MULTI_ORDER_ITEMS_BY_COD",
        "WIDGET_MULTI_ORDER_ITEMS_BY_FACILITY",
        "WIDGET_MULTI_ORDER_REVENUE_BY_COD",
        "WIDGET_MULTI_ORDER_REVENUE_BY_FACILITY",
        "WIDGET_MULTI_PENDING_FULFILLABLESALE_ORDER_STATUS",
        "WIDGET_MULTI_SALE_ORDER_FLOW_SUMMARY",
        "WIDGET_MULTI_SALE_ORDER_STATUS",
        "WIDGET_MULTI_SHIPMENTS_BY_PROVIDER",
        "WIDGET_MULTI_SHIPMENTS_PENDING_DELIVERY_BY_FACILITY",
        "WIDGET_MULTI_SHIPMENTS_PENDING_DELIVERY_BY_PROVIDER",
    ],
    "CONTENT_EDITOR": [
        "ADD_EDIT_SOI_DISCOUNT",
        "ADD_EDIT_SOI_SELLING_PRICE",
